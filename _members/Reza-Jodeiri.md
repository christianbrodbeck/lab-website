...
I'm currently implementing and extending the Shortlist B model (Norris & McQueen, 2008) to understand how human brains process continuous speech in real-world environments. My research focuses on developing implementations of Bayesian speech recognition models with Time-Resolved Function (TRF) capabilities for neuroscience applications. By integrating acoustic information, these implemented models generate cognitive measures that can be correlated with EEG/MEG data.
